<?php
/*
select JSON_EXTRACT(c_defaults, '$.Vacation') AS vacation from sogo_user_profile where c_uid = "unisexklo@cryopath.tech";



{"customSubject": "sees ${subject}", "weekdaysEnabled": 1, "discardMails": 1, "ignoreLists": 1, "endDate": 1737759600, "startTime": "1
8:00", "endTimeEnabled": 1, "endDateEnabled": 1, "alwaysSend": 1, "endTime": "08:00", "autoReplyEmailAddresses": ["unisexklo@cryopath.te
ch"], "days": ["0", "1", "2", "3", "6", "4"], "startDateEnabled": 1, "startDate": 1737673200, "autoReplyText": "aasdfasdfg", "startTimeE
nabled": 1, "daysBetweenResponse": "1", "customSubjectEnabled": 1, "enabled": 1}


update sogo_user_profile set c_defaults = JSON_SET(c_defaults, '$.sedation', JSON_EXTRACT('{"verbose":true, "type": "info"}', '$')) where c_uid = "fucky@cryopath.tech";
